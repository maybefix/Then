...
assert.equal(packageJson.version, "0.5.10", "the feature branch must identify itself as v0.5.10");
assert.equal(tauriConfig.version, packageJson.version, "frontend and Tauri versions must match");
assert.match(cargoManifest, /^version = "0\.5\.10"$/m, "Rust package version must match v0.5.10");
