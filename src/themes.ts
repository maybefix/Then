...
export const themeCatalog: ThemeDefinition[] = [
  ...
  { id: "newsroom-light", label: "Newsroom", description: "白い紙面と深紅の編集罫線", mode: "light" },
  { id: "sen-light", label: "Shuboku", description: "白地に墨と朱の編集罫線", mode: "light" },
  ...
  { id: "newsroom-dark", label: "Newsroom", description: "墨色の紙面と深紅の編集罫線", mode: "dark" },
  { id: "sen-dark", label: "Shuboku", description: "墨色の紙面と白・朱の編集罫線", mode: "dark" },
...
const legacyThemeAliases: Record<string, AppTheme> = {
  ...
  "energy-dark": "dark",
  "skeuo-light": "newsroom-light",
  "skeuo-dark": "newsroom-dark",
};
